...
document.write("Nombre: " + nombre + "<br>", "Cantidad: " + cantidad + "<br>", 
"Precio: " + precio + "<br>", "Disponible: " + disponible + "<br>", "Descripción: " + 
descripcion);

console.log("Nombre:", nombre, " Cantidad:", cantidad, 
" Precio:", precio, " Disponible:", disponible, " Descripción:", 
descripcion);